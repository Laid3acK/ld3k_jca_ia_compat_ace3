class CfgPatches
{
    class ld3k_jca_ia_compat_ace3
    {
        requiredAddons[]=
        {
            ...
            "Weapons_F_JCA_IA_Rifles_SCAR_H",
            "Weapons_F_JCA_IA_Rifles_SCAR_L",
...
class CfgAmmo
{
    ...
    class JCA_B_9x19_Ball_P320C_FMJ: BulletBase // M1152 Sig Sauer 9x19mm 115gr Full Metal Jacket FMJ https://cdn.bfldr.com/EN1VTHA0/at/k4vxwr73g8mj5bt485mh8bcz/2024_DSG_CATALOG__6-3-24_SL.pdf#page=57
    {
        ...
        ACE_dragModel=1;
        ACE_muzzleVelocities[]={362}; // Muzzle Velocities 70°F (21°C, MV 15°C +1m/s), 361m/s (1185fps, 3.9") ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_P320 initSpeed, 1185fps barrel length 4.0" ± 1/16" (± 3.9375", 4.0625") https://www.sigsauer.com/9mm-115gr-elite-ball-fmj.html
    ...
    class JCA_B_9x19_Ball_P320C_JHP: JCA_B_9x19_Ball_P320C_FMJ // M1153 Sig Sauer 9x19mm 147gr Jacketed Hollow Point JHP https://cdn.bfldr.com/EN1VTHA0/at/k4vxwr73g8mj5bt485mh8bcz/2024_DSG_CATALOG__6-3-24_SL.pdf#page=57
    {
        ...
        ACE_muzzleVelocities[]={301}; // Muzzle Velocities 70°F (21°C, MV 15°C +1m/s), 300m/s (985fps, 3.9") ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_P320 initSpeed, 985fps barrel length 4.0" ± 1/16" (± 3.9375", 4.0625") https://www.sigsauer.com/9mm-147gr-elite-v-crown-jhp-20ct.html
    ...
    class JCA_B_9x19_Ball_P226_FMJ: BulletBase // M17 Sig Sauer NATO 9x19mm +P 124gr Full Metal Jacket FMJ https://www.sigsauer.com/blog/sig-sauer-introduces-m17-9mm-p-ammunition
    {
        ...
        ACE_muzzleVelocities[]={366,398,430}; // Muzzle Velocities 70°F (21°C, MV 15°C +1m/s), 378m/s (1240fps) 4.4" (112mm) ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_P226 initSpeed
        hit=4.8; // Full Metal Jacket, 574 Joules, B_9x21_Ball 5
        indirectHit=0;
        indirectHitRange=0;
        cartridge="FxCartridge_9mm";
        cost=100;
        typicalSpeed=378; // JCA_15Rnd_9x19_P226_Mag and JCA_15Rnd_9x19_P226_JHP_Mag initSpeed
    ...
    class JCA_B_9x19_Ball_P226_SUB: JCA_B_9x19_Ball_P226_FMJ // M1153 Sig Sauer 9x19mm 147gr Jacketed Hollow Point JHP https://cdn.bfldr.com/EN1VTHA0/at/k4vxwr73g8mj5bt485mh8bcz/2024_DSG_CATALOG__6-3-24_SL.pdf#page=57
    {
        ...
        ACE_muzzleVelocities[]={301,327,354}; // Muzzle Velocities 70°F (21°C, MV 15°C +1m/s), 311m/s (1020fps) 4.4" (112mm) ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_P226 initSpeed
    ...
    class JCA_B_9x19_Ball_Glock17_FMJ: BulletBase // M17 Sig Sauer NATO 9x19mm +P 124gr Full Metal Jacket FMJ https://www.sigsauer.com/blog/sig-sauer-introduces-m17-9mm-p-ammunition
    {
        ACE_caliber=9.03; // 0.356" CIP diameter https://bobp.cip-bobp.org/uploads/tdcc/tab-iv/tabivcal-en-page28.pdf
        ACE_bulletLength=14.859; // 0.585" https://www.sigsauer.com/9mm-p-124gr-elite-ball-m17-fmj-box-50.html
        ACE_bulletMass=8.035; // 124gr
        ...
        ACE_ballisticCoefficients[]={0.196}; // ICAO G1 BC exterior ballistic app "EBC V2" based on Sig Sauer 2024 datas https://cdn.bfldr.com/EN1VTHA0/at/k4vxwr73g8mj5bt485mh8bcz/2024_DSG_CATALOG__6-3-24_SL.pdf#page=57
        ACE_velocityBoundaries[]={};
        ACE_standardAtmosphere="ICAO";
        ACE_dragModel=1;
        ACE_barrelLengths[]={101.6,127,228.6}; // default ACE3 4", 5", 9" barrel lengths
        ACE_muzzleVelocities[]={365,397,429}; // 365m/s (1198fps) barrel length 4", 381m/s barrel length 114mm ICAO (15°C, 1013.25 hPa, 0%) according to JCA magazines initSpeed
        hit=4.85; // Full Metal Jacket, 583 Joules, B_9x21_Ball 5
        indirectHit=0;
        indirectHitRange=0;
        cartridge="FxCartridge_9mm";
        cost=100;
        typicalSpeed=381; // JCA magazines initSpeed
        airFriction=-0.00186168; // ICAO (15°C, 1013.25hPa, 0%), airFrictionAnalysis.txt in docs folder
        caliber=1.2; // Full Metal Jacket
        deflecting=25;
        model="\A3\Weapons_f\Data\bullettracer\tracer_white";
        airLock=1;
    ...
    class JCA_B_9x19_Ball_Glock17_JHP: JCA_B_9x19_Ball_Glock17_FMJ // M17 Sig Sauer NATO 9x19mm +P 124gr V-Crown https://www.sigsauer.com/blog/sig-sauer-introduces-m17-9mm-p-ammunition
    {
        ACE_ballisticCoefficients[]={0.169}; // ICAO G1 BC exterior ballistic app "EBC V2" based on Sig Sauer 2024 datas https://cdn.bfldr.com/EN1VTHA0/at/k4vxwr73g8mj5bt485mh8bcz/2024_DSG_CATALOG__6-3-24_SL.pdf#page=57
        hit=8; // Jacketed Hollow Point, 583 Joules, B_9x21_Ball 5
        airFriction=-0.0021588; // ICAO (15°C, 1013.25hPa, 0%), airFrictionAnalysis.txt in docs folder
        caliber=0.72; // Jacketed Hollow Point, B_9x21_Ball 1.2
    };
    class JCA_B_9x19_Ball_Glock17_SUB: JCA_B_9x19_Ball_Glock17_FMJ // M1153 Sig Sauer 9x19mm 147gr Jacketed Hollow Point JHP https://cdn.bfldr.com/EN1VTHA0/at/k4vxwr73g8mj5bt485mh8bcz/2024_DSG_CATALOG__6-3-24_SL.pdf#page=57
    {
        ACE_bulletLength=14.859; // 0.585" 9mm 147gr Elite V-Crown JHP https://www.sigsauer.com/9mm-147gr-elite-v-crown-jhp-20ct.html
        ACE_bulletMass=9.525; // 147gr
        ACE_ballisticCoefficients[]={0.197}; // ICAO G1 BC exterior ballistic app "EBC V2" based on Sig Sauer 2024 datas https://cdn.bfldr.com/EN1VTHA0/at/k4vxwr73g8mj5bt485mh8bcz/2024_DSG_CATALOG__6-3-24_SL.pdf#page=57
        ACE_muzzleVelocities[]={300,326,353}; // 300m/s (985fps) barrel length 4", 313m/s barrel length 114mm ICAO (15°C, 1013.25 hPa, 0%) according to JCA magazines initSpeed
        hit=7.2; // Jacketed Hollow Point, 467 Joules, B_9x21_Ball 5
        typicalSpeed=313; // JCA magazines initSpeed
        airFriction=-0.00115953; // ICAO (15°C, 1013.25hPa, 0%), airFrictionAnalysis.txt in docs folder
        caliber=0.72; // Jacketed Hollow Point, B_9x21_Ball 1.2
        visibleFire=1; // Subsonic, B_127x54_Ball, BulletBase 3
        audibleFire=5; // Subsonic, B_127x54_Ball, B_9x21_Ball 30
    };
    ...
    class JCA_B_9x19_Ball_M9A1_FMJ: BulletBase // M17 Sig Sauer NATO 9x19mm +P 124gr Full Metal Jacket FMJ https://www.sigsauer.com/blog/sig-sauer-introduces-m17-9mm-p-ammunition
    {
        ...
        cartridge="FxCartridge_9mm";
        cost=100;
        typicalSpeed=394; // JCA_15Rnd_9x19_M9A1_Mag and JCA_15Rnd_9x19_M9A1_JHP_Mag initSpeed
    ...
    class JCA_B_9x19_Ball_MP5_FMJ: BulletBase // M17 Sig Sauer NATO 9x19mm +P 124gr FMJ https://www.sigsauer.com/blog/sig-sauer-introduces-m17-9mm-p-ammunition
    {
        ...
        ACE_dragModel=1;
        ACE_barrelLengths[]={101.6,127,228.6}; // default ACE3 4", 5", 9" barrel lengths
        ACE_muzzleVelocities[]={366,398,430}; // Muzzle Velocities 70°F (21°C, MV 15°C +1m/s), 365m/s (1198fps, 4"), 428m/s (1404fps) 8.858" (225mm) ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_MP5A5 initSpeed
    ...
    class JCA_B_45ACP_Ball_Mk23: BulletBase // Winchester Law Enforcement .45 ACP +P 230gr, 990fps (302m/s) barrel length 5" https://winchesterle.com/Ammunition/Products/Handgun/Ranger-T-Series/RA45TP
    {
        ...
        airFriction=-0.00106842; // ICAO conditions (15°C, 1013.25hPa, 0%), airFrictionAnalysis.txt in docs folder
        tracerScale=0.6;
    ...
    class JCA_B_45ACP_Ball_UMP45: BulletBase // Winchester Law Enforcement .45 ACP +P 230gr, 990fps (302m/s) barrel length 5" https://winchesterle.com/Ammunition/Products/Handgun/Ranger-T-Series/RA45TP
    {
        ...
        airFriction=-0.00103052; // ICAO conditions (15°C, 1013.25hPa, 0%), airFrictionAnalysis.txt in docs folder
        tracerScale=0.6;
        tracerStartTime=0.0075;
        tracerEndTime=5;
        nvgOnly=0; // B_45ACP_Ball w/o nvgOnly
    ...
    class JCA_B_762x51_Ball_SLAP_Tracer: JCA_B_762x51_Ball_SLAP // 7.62x51 XM949/M949 SLAP Tracer and CBJ Tech datas https://forum.cartridgecollectors.org/t/7-62mm-nato-slap-tracer-questions/7398
    {
        ACE_caliber=5.70; // https://bobp.cip-bobp.org/uploads/tdcc/tab-i/223-rem-170406-en.pdf
    ...
    class JCA_B_338LM_Ball: B_338_Ball // B_338_Ball, Lapua .338 LM Scenar 250gr GB488 https://www.lapua.com/product/338-lapua-mag-tactical-target-cartridge-scenar-162g-250gr-4318017/
    {
        ...
        ACE_muzzleVelocities[]={908}; // Muzzle Velocities 70°F (21°C, MV 15°C +2m/s), 906m/s (27") ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_5Rnd_338LM_Mag initSpeed
    ...
    class JCA_B_338LM_AP_Ball: JCA_B_338LM_Ball // Lapua .338 LM 248gr AP485 Armor Piercing https://www.lapua.com/product/338-lapua-mag-tactical-cartridge-armor-piercing-161g-248gr-4318035/
    {
        ...
        ACE_muzzleVelocities[]={908}; // Muzzle Velocities 70°F (21°C, MV 15°C +2m/s), 906m/s (27") ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_5Rnd_338LM_AP_Mag initSpeed
    ...
    class JCA_B_338LM_API_Ball: JCA_B_338LM_Ball // Lapua .338 LM 253gr API526 Armor Piercing Incendiary https://www.lapua.com/product/338-lapua-mag-tactical-cartridge-api526-164g-253gr-4318048/
    {
        ...
        ACE_muzzleVelocities[]={898}; // Muzzle Velocities 70°F (21°C, MV 15°C +2m/s), 896m/s (27") ICAO conditions (15°C, 1013.25hPa, 0%) according to JCA_5Rnd_338LM_API_Mag initSpeed
...
{
    class CA_Magazine;
    class JCA_17Rnd_9x19_P320_Mag; // JCA default config
    class JCA_15Rnd_9x19_P320C_FMJ_Mag: JCA_17Rnd_9x19_P320_Mag // M1152 Sig Sauer 9x19mm 115gr Full Metal Jacket FMJ
    {
        author="Laid3acK";
    ...
    class JCA_17Rnd_9x19_G17_Mag: CA_Magazine // JCA default config
    {
        displayName="9 mm 18Rnd G17 FMJ Mag";
        ammo="JCA_B_9x19_Ball_Glock17_FMJ"; // JCA_B_9x19_Ball
        mass=6.4; // magazine 17 rounds empty 80g + 17x 12.3g, 16Rnd_9x21_Mag 6, JCA 6
        initSpeed=381; // according to ACE_muzzleVelocities barrel length 114mm (4.5") ICAO (15°C, 1013.25hPa, 0%), 410
    };
    class JCA_17Rnd_9x19_G17_JHP_Mag: JCA_17Rnd_9x19_G17_Mag // M17 Sig Sauer NATO 9x19mm +P 124gr Jacketed Hollow Point JHP
    {
        author="Laid3acK";
    ...
    class JCA_17Rnd_9x19_G17_SUB_Mag: JCA_17Rnd_9x19_G17_Mag // M1153 Sig Sauer 9x19mm 147gr Jacketed Hollow Point JHP
    {
        author="Laid3acK";
        displayName="9 mm 18Rnd G17 Subsonic Mag";
        ammo="JCA_B_9x19_Ball_Glock17_SUB";
        mass=7; // magazine 17 rounds empty 80g + 17x 13.9g, 16Rnd_9x21_Mag 6, JCA 6
        initSpeed=313; // according to ACE_muzzleVelocities barrel length 114mm (4.5") ICAO (15°C, 1013.25hPa, 0%)
        displaynameshort="Subsonic";
    };
    ...
    class JCA_30Rnd_9x19_MP5_Mag: CA_Magazine // JCA default config, M17 Sig Sauer NATO 9x19mm +P 124gr Full Metal Jacket FMJ
    {
    ...
    class JCA_20Rnd_762x51_PMAG: CA_Magazine // JCA default config
    {
        ...
        mass=11.3; // 14.4 PMAGs SR25 20 rnds 5.9oz (167g) + 20x ~24.3g ~653g https://magpul.com/pmag20lr-srgenm3-7-62x51.html?mp_global_color=118, 20Rnd_762x51_Mag 12, JCA 9
    ...
    class JCA_20Rnd_762x51_M80A1_PMAG: JCA_20Rnd_762x51_PMAG
    {
        ...
        mass=11; // 14 PMAGs SR25 20 rnds 5.9oz (167g) + 20x ~23.3g ~633g https://magpul.com/pmag20lr-srgenm3-7-62x51.html?mp_global_color=118, 20Rnd_762x51_Mag 12, JCA 9
    ...
    class JCA_20Rnd_762x51_M993AP_PMAG: JCA_20Rnd_762x51_PMAG
    {
        ...
        mass=10.9; // 13.9 PMAGs SR25 20 rnds 5.9oz (167g) + 20x ~23.1g ~629g https://magpul.com/pmag20lr-srgenm3-7-62x51.html?mp_global_color=118, 20Rnd_762x51_Mag 12, JCA 9
    ...
    class JCA_20Rnd_762x51_Mk316_PMAG: JCA_20Rnd_762x51_PMAG
    {
        ...
        mass=11.9; // 15.2 PMAGs SR25 20 rnds 5.9oz (167g) + 20x ~26.2g ~691g https://magpul.com/pmag20lr-srgenm3-7-62x51.html?mp_global_color=118, 20Rnd_762x51_Mag 12, JCA 9
    ...
    class JCA_20Rnd_762x51_SLAP_PMAG: JCA_20Rnd_762x51_PMAG
    {
        ...
        mass=9.4; // 12 PMAGs SR25 20 rnds 5.9oz (167g) + 20x ~18.9g ~545g https://magpul.com/pmag20lr-srgenm3-7-62x51.html?mp_global_color=118, 20Rnd_762x51_Mag 12, JCA 9
    ...
    class JCA_20Rnd_762x51_SLAP_Tracer_PMAG: JCA_20Rnd_762x51_SLAP_PMAG
    {
        ...
        mass=9.3; // 11.9 PMAGs SR25 20 rnds 5.9oz (167g) + 20x ~18.7g ~541g https://magpul.com/pmag20lr-srgenm3-7-62x51.html?mp_global_color=118, 20Rnd_762x51_Mag 12, JCA 9
        tracersEvery=1;
    ...
    class JCA_20Rnd_762x51_Subsonic_PMAG: JCA_20Rnd_762x51_PMAG
    {
        ...
        mass=12.5; // 15.9 PMAGs SR25 20 rnds 5.9oz (167g) + 20x ~27.8g ~723g https://magpul.com/pmag20lr-srgenm3-7-62x51.html?mp_global_color=118, 20Rnd_762x51_Mag 12, JCA 9
    ...
    {
        ammo="JCA_B_762x51_Ball_M80";
        mass=12; // 15.3 SMAGs SR25 20 rnds 206g + 20x ~24.3g ~692g, 20Rnd_762x51_Mag 12, JCA 9
        initSpeed=820; // according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%)
        displaynameshort="M80";
    };
    class JCA_20Rnd_762x51_M80A1_SMAG: JCA_20Rnd_762x51_SMAG
    {
        ...
        ammo="JCA_B_762x51_Ball_M80A1";
        mass=11.6; // 14.8 SMAGs SR25 20 rnds 206g + 20x ~23.3g ~672g, 20Rnd_762x51_Mag 12, JCA 9
        initSpeed=889; // according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%)
        displaynameshort="M80A1";
    };
    class JCA_20Rnd_762x51_M993AP_SMAG: JCA_20Rnd_762x51_SMAG
    {
        ...
        ammo="JCA_B_762x51_Ball_M993AP";
        mass=11.5; // 14.7 SMAGs SR25 20 rnds 206g + 20x ~23.1g ~668g, 20Rnd_762x51_Mag 12, JCA 9
        initSpeed=915; // according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%)
        displaynameshort="M993 AP";
    };
    class JCA_20Rnd_762x51_Mk316_SMAG: JCA_20Rnd_762x51_SMAG
    {
        ...
        ammo="JCA_B_762x51_Ball_Mk316";
        mass=12.6; // 16.1 SMAGs SR25 20 rnds 206g + 20x ~26.2g ~730g, 20Rnd_762x51_Mag 12, JCA 9
        initSpeed=790; // according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%)
        displaynameshort="Mk316";
    };
    ...
    class JCA_20Rnd_762x51_SLAP_SMAG: JCA_20Rnd_762x51_SMAG
    {
        ...
        ammo="JCA_B_762x51_Ball_SLAP";
        mass=10.1; // 12.9 SMAGs SR25 20 rnds 206g + 20x ~18.9g ~584g, 20Rnd_762x51_Mag 12, JCA 9
        initSpeed=1190; // according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%)
        displaynameshort="SLAP";
    };
    class JCA_20Rnd_762x51_SLAP_Tracer_SMAG: JCA_20Rnd_762x51_SLAP_SMAG
    {
        ...
        ammo="JCA_B_762x51_Ball_SLAP_Tracer";
        mass=10; // 12.8 SMAGs SR25 20 rnds 206g + 20x ~18.7g ~580g, 20Rnd_762x51_Mag 12, JCA 9
        tracersEvery=1;
        displaynameshort="SLAP Tracer";
    };
    class JCA_20Rnd_762x51_Subsonic_SMAG: JCA_20Rnd_762x51_SMAG
    {
        ...
        ammo="JCA_B_762x51_Ball_Subsonic";
        mass=13.2; // 16.8 SMAGs SR25 20 rnds 206g + 20x ~27.8g ~762g, 20Rnd_762x51_Mag 12, JCA 9
        initSpeed=340; // according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%)
        displaynameshort="Subsonic";
    };
    ...
    class JCA_10Rnd_127x99_M107_Mag: CA_Magazine // JCA default config
    {
    ...
    class JCA_10Rnd_127x99_M107_Tracer_Red_Mag: JCA_10Rnd_127x99_M107_Mag // JCA default config
    {
        displayName="12.7 mm 10Rnd M107A1 M33 Tracer (Red) Mag";
        ammo="JCA_B_127x99_Ball_M33_Tracer_Red";
        displaynameshort="Tracer";
    };
    class JCA_10Rnd_127x99_M107_Tracer_IR_Mag: JCA_10Rnd_127x99_M107_Tracer_Red_Mag // JCA default config
    {
    ...
    class JCA_10Rnd_127x99_APDS_M107_Mag: JCA_10Rnd_127x99_M107_Mag // JCA default config
    {
    ...
    class JCA_10Rnd_127x99_APDS_M107_Tracer_Red_Mag: JCA_10Rnd_127x99_M107_Tracer_Red_Mag // JCA default config
    {
    ...
    class JCA_10Rnd_127x99_M107_Sand_Mag: JCA_10Rnd_127x99_M107_Mag // JCA default config
    {
        displayName="12.7 mm 10Rnd M107A1 M33 Sand Mag";
    };
    class JCA_10Rnd_127x99_M107_Sand_Tracer_Red_Mag: JCA_10Rnd_127x99_M107_Sand_Mag // JCA default config
    {
        displayName="12.7 mm 10Rnd M107A1 M33 Tracer (Red) Sand Mag";
        ammo="JCA_B_127x99_Ball_M33_Tracer_Red";
        displaynameshort="Tracer";
    };
    class JCA_10Rnd_127x99_M107_Sand_Tracer_IR_Mag: JCA_10Rnd_127x99_M107_Sand_Tracer_Red_Mag // JCA default config
    {
    ...
    class JCA_10Rnd_127x99_APDS_M107_Sand_Mag: JCA_10Rnd_127x99_M107_Sand_Mag // JCA default config
    {
    ...
    class JCA_10Rnd_127x99_APDS_M107_Sand_Tracer_Red_Mag: JCA_10Rnd_127x99_M107_Sand_Tracer_Red_Mag // JCA default config
    {
...
class CfgMagazineWells
{
    ...
    class JCA_G17_9x19 // Weapon initSpeed -1 ACE_barrelLength 114mm (4.5"): 381, 313m/s ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_17Rnd_9x19_G17 magazines initSpeed
    {
        JCA_Magazines[]=
        {
    ...
    class JCA_SR_762x51
    {
        JCA_Magazines[]= // Weapon initSpeed -1 ACE_barrelLength 508mm (20"): 820, 889, 915, 790, 909, 1190, 340m/s ICAO conditions (15°C, 1013.25 hPa, 0%) according to JCA_20Rnd_762x51 magazines initSpeed
        {
...
class CfgWeapons
{
    ...
    {
        ACE_barrelLength=114; // https://eu.glock.com/en/Products/Pistols/G17-Gen6
        ACE_barrelTwist=250; // CIP twist https://bobp.cip-bobp.org/uploads/tdcc/tab-iv/tabivcal-en-page28.pdf
        initSpeed=-1; // 381, 313m/s according to ACE_muzzleVelocities ICAO (15°C, 1013.25hPa, 0%), 375
        magazines[]=
        {
            "JCA_17Rnd_9x19_G17_Mag",
            "JCA_17Rnd_9x19_G17_JHP_Mag",
        ...
        class Single: Mode_SemiAuto
        {
            dispersion=0.00111; // 6.79 MOA (*0.562*0.000291), 0.562 value from https://github.com/acemod/ACE3/pull/5755, JCA 0.0048 (16.5 MOA)
        };
        class WeaponSlotsInfo: WeaponSlotsInfo
        {
            mass=13.2; // 600g w/o magazine, 20
        };
    };
    ...
    class JCA_arifle_SR10_base_F: Rifle_Base_F
    {
        ...
        initSpeed=-0.933; // 765, 830, 854, 737, 848, 1110, 317m/s according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%), JCA 715
        magazines[]=
        {
            "JCA_20Rnd_762x51_PMAG",
            "JCA_20Rnd_762x51_Red_PMAG",
        ...
        class single: Mode_SemiAuto
        {
            dispersion=0.000502; // 3.07 MOA (*0.562*0.000291), 0.562 value from https://github.com/acemod/ACE3/pull/5755, JCA 0.00066 (2.27 MOA)
        };
    };
    ...
    class JCA_arifle_SR25_base_F: Rifle_Base_F // https://en.wikipedia.org/wiki/SR-25
    {
        ...
        initSpeed=-1; // 820, 889, 915, 790, 909, 1190, 340m/s according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%), JCA 715
        ...
        class single: Mode_SemiAuto
        {
            dispersion=0.000267; // 1.63 MOA (*0.562*0.000291), 0.562 value from https://github.com/acemod/ACE3/pull/5755, JCA 0.00066 (2.27 MOA)
        };
    };
    ...
    {
        ACE_ScopeZeroRange=100; // Always keep vanilla discreteDistance 100 same that Range Card zeroed distance, to increase eventually zeroing distance: Interaction Menu -> "Set zero adjustment" (AB enabled only)
        ACE_ScopeHeightAboveRail=3.85973; // ACE3 checkScopes.sqf
    ...
    class muzzle_snds_acp: muzzle_snds_H // Sound Suppressor .45 ACP
    {
        class ItemInfo: ItemInfo
        {
            ...
            class MagazineCoef
            {
                initSpeed=1; // ACE3, muzzle_snds_acp 1.05
            };
            class AmmoCoef
            {
                hit=1;
            ...
            class MuzzleCoef
            {
                dispersionCoef=1; // ACE3 0.95, muzzle_snds_acp 0.8
                artilleryDispersionCoef=1;
                fireLightCoef=0.1;
                recoilCoef=0.95; // ACE3, muzzle_snds_acp 1
                recoilProneCoef=0.95; // ACE3, muzzle_snds_acp 1
